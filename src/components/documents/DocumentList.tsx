...
import { Badge } from '@/components/ui/badge';
import {DocumentListProps} from "@/types/documents/listPropsType";
                    ...
                    <CardContent className="p-5">
                        ...
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    <DropdownMenuItem onClick={() => onViewAction?.(doc)}>
                                        <Eye className="mr-2 h-4 w-4" />
                                        Ver documento
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => onConvertAction?.(doc, 'json')}>
                                        <Code2 className="mr-2 h-4 w-4" />
                                        Convertir a JSON
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => onConvertAction?.(doc, 'bio')}>
                                        <Database className="mr-2 h-4 w-4" />
                                        Convertir a BIO
                                    </DropdownMenuItem>
                                    <DropdownMenuItem
                                        onClick={() => onDeleteAction?.(doc)}
                                        className="text-destructive focus:text-destructive"
                                    >
                                        <Trash2 className="mr-2 h-4 w-4" />
                                        Eliminar
